...
def _(mo):
    routes = [
        {"name": "Bay Bridge", "color": [255, 0, 0], "path": [[-122.3907, 37.7914], [-122.3716, 37.7892], [-122.3542, 37.7876], [-122.3322, 37.7858], [-122.3172, 37.7948]]},
        {"name": "Golden Gate Bridge", "color": [255, 165, 0], "path": [[-122.4783, 37.8100], [-122.4745, 37.8120], [-122.4710, 37.8155], [-122.4690, 37.8200], [-122.4680, 37.8270]]},
        {"name": "Market Street", "color": [0, 200, 255], "path": [[-122.3950, 37.7916], [-122.4050, 37.7880], [-122.4150, 37.7840], [-122.4250, 37.7800], [-122.4350, 37.7762]]},
        {"name": "Embarcadero", "color": [0, 255, 100], "path": [[-122.3890, 37.7952], [-122.3930, 37.7980], [-122.3960, 37.8020], [-122.3980, 37.8060], [-122.3988, 37.8100], [-122.3985, 37.8140]]},
    ]
...
@app.cell
def _(dgl, mo):
    map_widget = dgl.Map(basemap="dark-matter", center=(-122.42, 37.80), zoom=13)
...
@app.cell
def _(dgl, map_widget, rounded_toggle, routes, width_slider):
